...
def get_filters():
    ...
    print('There are data for only three cities: Chicago, New york city and Washington')
    print('Months with valid names are: All or January-June ')
    print('Dates with valid names are: All or Sunday-Saturday ')
...
def user_stats(df):
    ...
    def display_raw_data(df):
        """Displays rows of individual trip data based on user input."""
